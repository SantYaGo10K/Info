...
Un evento como la X Carrera Nocturna SantYaGo10K requiere de una amplia disposición de medios, ya que es necesario
...
[Recorrido](https://www.santyago10k.run/es/durante/recorrido){ .md-button .md-button--primary }

## Horas Importantes

El evento tiene lugar el **Sábado, 30 de Mayo del 2026**. Con respecto a lo deportivo, las horas a tener en cuenta
son las siguientes:
